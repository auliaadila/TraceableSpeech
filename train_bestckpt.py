...
def train(rank, a, h):
    ...
    best_audiomark_loss = float("inf")  # Initialize best validation error
    ...
    for epoch in range(max(0, last_epoch), a.training_epochs):
        ...
        for i, batch in enumerate(train_loader):
            ...
            y_g_hat = generator(q, sign_trait) # [32, 1, 12000]

            y_g_hat, Opera = attack(y_g_hat, [("CLP", 0.4), ("RSP-90", 0.05), ("Noise-W35", 0.25), ("SS-01", 0.05), ("AS-90", 0.05), ("EA-0301", 0.15), ("LP5000", 0.05)])
            ...
            if rank == 0:
                ...
                if steps % a.stdout_interval == 0:
                    ...
                    print('Steps : {:d}, Gen Loss Total : {:4.3f}, Loss Q : {:4.3f}, Mel-Spec. Error : {:4.3f}, audiomark_loss : {:4.3f}, Opera: {}, s/b : {:4.3f}'.
                          format(steps, loss_gen_all, loss_q, mel_error, audiomark_loss, Opera, time.time() - start_b))
                ...
                if steps % a.validation_interval == 0 and steps != 0:
                    ...
                    with torch.no_grad():
                        for j, batch in enumerate(validation_loader):
                            ...
                            y_g_hat, Opera = attack(y_g_hat, [("CLP", 0.4), ("RSP-90", 0.05), ("Noise-W35", 0.15), ("SS-01", 0.05), ("AS-90", 0.05), ("EA-0301", 0.25), ("LP5000", 0.05)])
                        ...
                        if val_err + audiomark_loss < best_val_err + best_audiomark_loss: #take account of both loss function
                            best_val_err = val_err
                            best_audiomark_loss = audiomark_loss
...
def main():
    ...
    parser.add_argument('--summary_interval', default=100, type=int) # 100 # $ tensorboard --logdir /your_path/ --port 8080
    parser.add_argument('--validation_interval', default=500, type=int) # 20 1000 500
    parser.add_argument('--num_ckpt_keep', default=1, type=int) # 5
